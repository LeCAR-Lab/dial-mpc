...
@dataclass
class HighTorqueHiWalkEnvConfig(BaseEnvConfig):
...
class HighTorqueHiWalkEnv(BaseEnv):
    ...
    def make_system(self, config: HighTorqueHiWalkEnvConfig) -> System:
        model_path = get_model_path("highTorque_hi", "mjx_scene_hi_walk.xml")
...
class HighTorqueHiPushCrateEnvConfig(HighTorqueHiWalkEnvConfig):
    pass


class HighTorqueHiPushCrateEnv(HighTorqueHiWalkEnv):
    def __init__(self, config: HighTorqueHiPushCrateEnvConfig):
        super().__init__(config)
        self.physical_joint_range = self.physical_joint_range[:-1]

    def make_system(self, config: HighTorqueHiPushCrateEnvConfig) -> System:
